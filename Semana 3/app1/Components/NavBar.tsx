...
import { HomeIcon , AccessibilityInsetIcon, ArchiveIcon, BookIcon } from "@primer/octicons-react";

export default function NavBar() {

 const navItem=[
    {path:'/contacto', text:"Contacto", icon: <AccessibilityInsetIcon/>},
